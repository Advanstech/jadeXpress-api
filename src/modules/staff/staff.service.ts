...
const safeSelect = {
  ...
  ssnitNumber: staffProfile.ssnitNumber,
  tinNumber: staffProfile.tinNumber,
  bankName: staffProfile.bankName,
  bankAccountName: staffProfile.bankAccountName,
  bankAccountNumber: staffProfile.bankAccountNumber,
  bankBranch: staffProfile.bankBranch,
  mobileMoneyProvider: staffProfile.mobileMoneyProvider,
  mobileMoneyNumber: staffProfile.mobileMoneyNumber,
  basicSalaryPesewas: staffProfile.basicSalaryPesewas,
  employmentType: staffProfile.employmentType,
  employmentDate: staffProfile.employmentDate,
  nextOfKinName: staffProfile.nextOfKinName,
  nextOfKinPhone: staffProfile.nextOfKinPhone,
  nextOfKinRelationship: staffProfile.nextOfKinRelationship,
  payrollEnabled: staffProfile.payrollEnabled,
